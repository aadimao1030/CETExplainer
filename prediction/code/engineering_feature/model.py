...
class GenerateFeature(nn.Module):
    def __init__(self, hidden_channels, encoder, summary, feat, index):
        ...
        self.act = nn.Sigmoid()
        self.fc = nn.Linear(self.feature_dim, 128) #The 64 here is outputchannal
        self.fd = nn.Linear(self.feature_dim, 128) #The 64 here is outputchannal

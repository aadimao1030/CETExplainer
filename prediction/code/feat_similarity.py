...
x_cell = pd.read_csv("../data/node_representation/x_cell_64_epoch5000.csv", header=0)
x_drug = pd.read_csv("../data/node_representation/x_drug_64_epoch5000.csv", header=0)
...
print(f'Proportion of cells：{round(len(cell_triples)/x_cell.shape[0]/x_cell.shape[0],3)}, Proportion of drugs：{round(len(drug_triples)/x_drug.shape[0]/x_drug.shape[0],3)}')

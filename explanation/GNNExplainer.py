...
if __name__ == '__main__':
    ...
    for fold in range(2, 3 ):
        ...
        with strategy.scope():
            ...
            model.load_weights(os.path.join(f'../prediction/data/weights/mode0_fold{fold}_epoch5000_learnRate0.001_batchsize256_embdim64_layer2.h5'))
        ...
        np.savez(f'data/GNNExplainer_preds_fold{fold}_layer2_epoch5000.npz',preds=out_preds)
        print('Done.')

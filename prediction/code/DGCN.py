            ...
            for ed in embedding_dim:
                ...
                for mode in range(0, 1):
                    ...
                    for fold in range(0, 5):
                        ...
                        all_feature_matrix = pd.read_csv(f"../data/node_representation/x_all_{EMBEDDING_DIM}_epoch1000.csv", header=0)
                        ...
                        save_path_template = os.path.join('../data', 'weights', 'mode{mode}_fold{fold}_epoch{epoch}_learnRate{learning_rate}_batchsize{batch_size}_embdim{EMBEDDING_DIM}_layer2_1000.h5')
